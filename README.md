...
4. **Устанвока некторых библиотек**
   Все библиотеки можно устанвоить, следуя пункту 2, но при исспользовании вименно rasberry pi5, и исспользовани библиотеки RPi.GPIO, следует исспользовать установку через:
   ```
   - sudo apt remove python3-rpi.gpio
   - python3 -m pip install rpi-lgpio
   ```
   Для коректной работы данного модуля для сичтывания данных с счетчика гейгера и газового датчика.
